...
class Player(WeaponUser):
    ...
    def run_acceleration(self):
        ...
        if self.deceleration_path.has_finished():
            GameMovement.run_acceleration(self, game_button_is_pressed(self.left_key) or game_button_is_pressed(self.right_key), self.acceleration_path, PLAYER_MAX_HORIZONTAL_VELOCITY)
